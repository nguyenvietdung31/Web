...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/grid.css?>v=11">
        ...
        <div class="header">
            <nav class="header__navbar">
                <ul class="header__navbar-list">
                    ...
                    <li class="header__navbar-item">
                        <a href="#" class="header__navbar-link"><span>Liên hệ</span><!--<i class="fab fa-facebook"></i><i class="fab fa-instagram"></i>--> </a>
                    </li>
                </ul>
                <ul class="header__navbar-list">
                    <li class="header__navbar-item">
